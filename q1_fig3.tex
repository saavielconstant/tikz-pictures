...
%  \begin{document}
     		...
     		\newcommand{\setI}
     		{(5,25)(10,22)(10,17)(15,20)(13,15)(18,13)(20,17)(23,12)(25,19)(27,10)}
     		\draw[color=gray!20] (0,27) grid (27,0);
     		\draw[->,thick] (0,0)--(0,27) node[above]{$y$};
     		\draw[->,thick] (0,0)--(27,0) node[right]{$x$};
     		\foreach \y in {5,10,...,25} \draw(0,\y)node[left]{$\y$};
     		\foreach \x in {5,10,...,25} \draw (\x,0) node[below]{$\x$};
     		\node[below left] at (0,0){$0$};
     		\draw (11,5) rectangle (20,1);
     		\node[right] at (12,3){\textbf{Set III}};
     		\draw (16,-4) node{$X$};
